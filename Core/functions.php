...
$url = "https://api.telegram.org/bot6096808379:AAEPW9b-Tmr2irugyAyA8RG9QF1_Sw4z5kE/editMessageText?chat_id=".$chatId."&message_id=".$message_id."&text=".$message."&parse_mode=HTML";
file_get_contents($url);      
}
