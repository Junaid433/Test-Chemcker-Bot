...
$url = "https://api.telegram.org/bot6156162011:AAFpad9_GzesePHMO29kD_0M2uqwR3LUHgs/editMessageText?chat_id=".$chatId."&message_id=".$message_id."&text=".$message."&parse_mode=HTML";
file_get_contents($url);      
}
